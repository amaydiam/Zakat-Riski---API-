...
insert  into `amil_zakat`(`id_amil_zakat`,`id_user`,`id_badan_amil_zakat`,`status_amil_zakat`) values (1,1,1,'Aktif'),(2,7,2,'Aktif');
...
insert  into `mustahiq`(`id_mustahiq`,`id_calon_mustahiq`,`id_amil_zakat`,`status_mustahiq`) values (2,2,3,'Aktif'),(4,6,1,'Aktif'),(5,5,3,'Aktif'),(6,4,2,'Aktif'),(7,7,2,'Aktif'),(8,8,2,'Aktif'),(9,9,2,'Aktif'),(10,11,2,'Aktif'),(11,13,4,'Aktif'),(12,1,3,'Aktif'),(13,10,3,'Aktif'),(14,21,3,'Aktif'),(15,23,3,'Aktif'),(16,20,2,'Aktif'),(17,24,3,'Aktif'),(18,25,2,'Aktif'),(19,22,3,'Aktif'),(20,19,3,'Aktif'),(21,18,3,'Aktif'),(22,15,4,'Aktif'),(23,29,3,'Aktif');
...
insert  into `rating_calon_mustahiq`(`id_rating_calon_mustahiq`,`id_calon_mustahiq`,`id_user`,`rating`) values (9,37,1,5),(10,36,1,4),(11,25,NULL,5),(12,23,NULL,3);
...
insert  into `user`(`id_user`,`username`,`password`,`nama`,`alamat`,`no_telp`,`no_identitas`,`tipe_user`,`status`) values (1,'admin','123','Rizki',NULL,NULL,NULL,'1','Aktif'),(2,'amay','123','Amay Diam','xsvs','cv','dvd','2','Aktif'),(3,'dika','123','Dika Pratama','dvdv','vds','dvdv','2','Aktif'),(5,'jamal','123','amay','djdkdkd','656555','56555','2','Aktif'),(6,'ayam','123','bzjdjd','xjfkfkf','565655','565259090','2','Aktif');
...
insert  into `validasi_mustahiq`(`id_validasi_mustahiq`,`id_mustahiq`,`id_amil_zakat`) values (1,2,1),(2,2,2);
